		...
		<table class="table table-bordered datatable" id="tabla">
			...
			<tbody>
				...
				<tr>
					<td>{{ $marca->nombre }}</td>
					<td>
					<a href="javascript:;" class="btn btn-orange btn-xs tooltip-primary" onclick="editarColor('{{URL::to('/marcas/editar/'.$marca->id)}}');" data-toggle="tooltip" data-placement="top" data-original-title="editar"><i class="fa fa-edit"></i></a>
					<a href="{{URL::to('/marcas/eliminar/'.$marca->id)}}" class="btn btn-danger btn-xs tooltip-primary" data-toggle="tooltip" data-placement="top" data-original-title="eliminar"><i class="glyphicon glyphicon-trash"></i></a>
					</td>
				</tr>
			@endforeach
			</tbody>
