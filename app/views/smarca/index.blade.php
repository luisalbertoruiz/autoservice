...
<div class="page-container">	
	...
	<hr>
		<table class="table table-bordered datatable" id="tabla">
			...
			<tbody>
				@foreach($smarcas as $smarca)
				<tr>
					<td>{{ $smarca->marca->nombre }}</td>
					<td>{{ $smarca->nombre }}</td>
					<td>
					<a href="javascript:;" class="btn btn-orange btn-xs tooltip-primary" onclick="editarColor('{{URL::to('/smarcas/editar/'.$smarca->id)}}');" data-toggle="tooltip" data-placement="top" data-original-title="editar"><i class="fa fa-edit"></i></a>
					<a href="{{URL::to('/smarcas/eliminar/'.$smarca->id)}}" class="btn btn-danger btn-xs tooltip-primary" data-toggle="tooltip" data-placement="top" data-original-title="eliminar"><i class="glyphicon glyphicon-trash"></i></a>
					</td>
				</tr>
			@endforeach
			</tbody>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Nueva Sub-Marca</h4>
			</div>
...
<div class="modal fade" id="modal-8">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title">Editar Sub-Marca</h4>
			</div>
			<div class="modal-body">
				Content is loading...
			</div>
